    ...
    def post(self, request):
        ...
        if 'monthly_snapshot_submit' in request.POST:
            ...
            if form.is_valid():
                ...
                return redirect(reverse('backoffice:monthly_snapshot', args=[year, month]))
            ...
            if form.is_valid():
                ...
                return redirect(reverse('backoffice:quality_control', args=[year, month]))
            ...
            if form.is_valid():
                ...
                return redirect(reverse('backoffice:temporal_aggregation', args=[aggregation_type, start_date, end_date]))
